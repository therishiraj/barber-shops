...
function getCoord(e) {
	var 	carPos = username.selectionEnd,
        ...
        usernameCoords = {}, caretCoords = {}, centerCoords = {}
	;
	...
	usernameCoords = getPosition(username);							//console.log("emailCoords.x: " + emailCoords.x + ", emailCoords.y: " + emailCoords.y);
